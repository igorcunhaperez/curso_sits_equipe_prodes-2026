...
# Package for manipulating spatial vector data in R (a modern replacement for sp).
# Allows you to work with shapefiles, GeoJSON, and other vector formats, as well as perform spatial operations such as intersections, buffers, and projection transformations.
...
# Allows you to perform operations such as filter, select, mutate, summarize, and group_by in a clear, fast, and readable manner.
# Essential for data analysis, especially in tidyverse workflows.

library(rstac)
# https://brazil-data-cube.github.io/rstac/
# Package that allows you to interact with data catalogs that follow the STAC (SpatioTemporal Asset Catalog) standard.
# Facilitates searches, filtering, and access to metadata and assets (images, mosaics, collections) hosted in STAC catalogs, such as BDC, AWS, etc.
